...
class EntryPayPurchaseItem implements SchemaEntryAbstract {
  ...
  //
  @override
  EntryPayPurchaseItem.from(Map<String, dynamic> row):
    _entry = SchemaEntry.from(row, def: _initial),
    _isEmpty = false;
  //
  //
  EntryPayPurchaseItem.empty():
  ...
  ///
  ///
  static Sql updateSqlBuilder(Sql sql, EntryPayPurchaseItem entry) {
