      ...
      schema: TableSchema<EntryCustomerOrder, void>(
        ...
        fields: [
          ...
          // const Field(hidden: false, editable: true, key: 'product'),
                Field(flex: 05, hidden: false, editable: true, title: 'Count'.inRu, key: 'count'),
                Field(flex: 05, hidden: false, editable: true, title: 'Cost'.inRu, key: 'cost'),
                Field(flex: 05, hidden: false, editable: true, title: 'Paid'.inRu, key: 'paid'),
                Field(flex: 05, hidden: false, editable: true, title: 'Distributed'.inRu, key: 'distributed'),
                Field(flex: 05, hidden: false, editable: true, title: 'To refound'.inRu, key: 'to_refound'),
                Field(flex: 05, hidden: false, editable: true, title: 'Refounded'.inRu, key: 'refounded'),
